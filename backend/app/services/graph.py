        ...
        if not self.use_mock and self._app:
            try:
                ...
                if user:
                    ...
                    path = f"/users/{upn}/calendarview?startDateTime={start}&endDateTime={end}&$orderby=start/dateTime"
                else:
                    path = f"/me/calendarview?startDateTime={start}&endDateTime={end}&$orderby=start/dateTime"
            except Exception:
                path = f"/me/calendarview?startDateTime={start}&endDateTime={end}&$orderby=start/dateTime"
        else:
            path = f"/me/calendarview?startDateTime={start}&endDateTime={end}&$orderby=start/dateTime"
