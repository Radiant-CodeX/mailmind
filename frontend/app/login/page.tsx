    ...
    >
      <div className="relative w-full max-w-md bg-base-100 border border-base-300 rounded-2xl shadow-2xl p-8 overflow-hidden">
        ...
        <div className="text-center mb-8 flex flex-col items-center">
          ...
          <p className="text-[10px] text-base-content/60 font-bold uppercase tracking-widest mt-0.5">
            Co-pilot Studio
          </p>
        </div>
        ...
        {signedOutNotice === "full" && (
          <div className="mb-4 p-3 bg-base-200 border border-base-300 text-base-content/60 rounded-lg text-xs font-semibold text-center">
          ...
          <div className="space-y-4">
            ...
            {remembered && (
              <div className="mb-5 animate-fade-in">
                <button
                  ...
                  disabled={loading}
                  className="w-full flex items-center gap-3 p-3 bg-base-200 hover:bg-base-200/70 border border-base-300 hover:border-primary/40 rounded-xl transition-all cursor-pointer disabled:opacity-50 active:scale-[0.98] text-left group"
                  id="btn-quick-login"
                >
                  <div className="w-10 h-10 rounded-full bg-primary flex items-center justify-center text-base-100 font-extrabold text-sm shrink-0 shadow">
                  ...
                  {loading ? (
                    <div className="w-4 h-4 border-2 border-primary border-t-transparent animate-spin rounded-full shrink-0" />
                  ) : (
                    <svg
                      className="w-5 h-5 text-base-content/60 group-hover:text-primary transition-colors shrink-0"
                      fill="none"
                      stroke="currentColor"
                      viewBox="0 0 24 24"
                    >
                ...
                <button
                  ...
                  className="mt-2 w-full text-[11px] font-semibold text-base-content/60 hover:text-base-content transition-colors cursor-pointer"
            ...
            <form onSubmit={handleNext} className="space-y-3">
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full flex items-center justify-center gap-2 py-3 bg-primary hover:bg-primary/90 disabled:opacity-50 text-base-100 font-extrabold text-sm rounded-xl cursor-pointer shadow hover:shadow-lg transition-all duration-200 active:scale-95"
                id="btn-login-next"
              >
                {loading ? (
                  <div className="w-4 h-4 border-2 border-base-100 border-t-transparent animate-spin rounded-full" />
                ) : (
                  "Next"
                )}
              </button>
        ...
        {msWaiting && (
          <div className="space-y-5 animate-fade-in text-center">
            <div className="w-14 h-14 rounded-2xl bg-white flex items-center justify-center mx-auto shadow-md border border-base-300">
            ...
            <div>
              <p className="text-[10px] font-bold uppercase tracking-widest text-base-content/60 mb-1">
                Sign-in in progress
              </p>
            ...
            <button
              ...
              className="w-full py-2.5 bg-base-200 hover:bg-red-500/10 border border-base-300 hover:border-red-500/20 rounded-xl text-xs font-bold text-base-content/60 hover:text-red-500 transition-all cursor-pointer"
            >
              Cancel
            </button>
          </div>
      ...
      {/* Footer */}
      <footer className="absolute bottom-0 left-0 right-0 border-t border-base-300 px-6 py-5 bg-base-100">
        <div className="max-w-2xl mx-auto flex items-center justify-between gap-4 text-xs text-base-content/50">
