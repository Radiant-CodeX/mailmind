        ...
        >
          ...
          <div className="flex-1 min-w-0 space-y-2">
            <div className="flex items-center justify-between gap-3">
              {/* Sender */}
              <div className="h-3 rounded bg-base-200 w-32" />
              {/* Timestamp */}
              <div className="h-2.5 rounded bg-base-200 w-14" />
            </div>
            {/* Subject */}
            <div className="h-3 rounded bg-base-200 w-3/4" />
            {/* Preview */}
            <div className="h-2.5 rounded bg-base-200 w-1/2" />
          </div>
        </div>
      ))}
    </div>
