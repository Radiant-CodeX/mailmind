        ...
        >
          {!isCollapsed ? (
            <div className="flex items-center gap-3 animate-fade-in text-left">
              ...
              <img src="/mailmind-logo.svg" alt="MailMind" width={32} height={32} className="w-8 h-8 rounded-lg shadow" />
              <div>
            ...
            // eslint-disable-next-line @next/next/no-img-element
            <img src="/mailmind-logo.svg" alt="MailMind" width={32} height={32} className="w-8 h-8 rounded-lg mx-auto shadow animate-fade-in" />
          )}
        </div>
