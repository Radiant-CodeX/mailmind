    ...
    <div className="text-left space-y-4" id="commitment-gate">
      ...
      <div className="space-y-3">
        {loading ? (
          ...
          <div className="p-4 bg-[var(--bg-elevated)] border border-[var(--border)] rounded-lg space-y-4 text-left animate-fade-in" id="commitments-confirmed">
            ...
            {taskUrls.length > 0 && (
              <div className="space-y-1.5 pt-2 border-t border-[var(--border-subtle)]">
                <h4 className="text-[10px] font-bold text-[var(--text-primary)] uppercase tracking-wider">MS To-Do Tasks</h4>
                {taskUrls.map((url, idx) => (
                  <a
                    ...
                    className="flex items-center gap-1 text-[11px] text-[var(--accent-primary)] hover:underline truncate max-w-full font-medium"
                  >
            ...
            {eventUrls.length > 0 && (
              <div className="space-y-1.5 pt-2 border-t border-[var(--border-subtle)]">
                <h4 className="text-[10px] font-bold text-[var(--text-primary)] uppercase tracking-wider">Calendar Events</h4>
                {eventUrls.map((url, idx) => (
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="flex items-center gap-1 text-[11px] text-[var(--text-primary)] hover:underline truncate max-w-full font-medium"
                  >
                    <svg className="w-3.5 h-3.5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
      ...
      {!confirmed && commitments.length > 0 && (
        <div className="pt-4 border-t border-[var(--border-subtle)]">
          <ConfirmButton
            ...
            loading={confirming}
          />
          <p className="mt-2 text-[10px] text-center text-[var(--text-muted)] font-medium">
